  ...
  return (
    <div className="min-h-screen transition-colors duration-200 flex flex-col relative">
      <div className="relative z-10 flex flex-col flex-1">
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/50 dark:bg-gray-900/50 backdrop-blur-[2px] border-b border-gray-200/30 dark:border-gray-800/30 transition-colors duration-200 p-4 flex items-center justify-between">
