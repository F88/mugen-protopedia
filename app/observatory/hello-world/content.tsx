...
function DashboardSkeleton() {
  return (
    <div className="space-y-12 animate-pulse">
      ...
      {/* Birth Pulse Section Skeleton */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white/5 rounded-2xl p-8 h-96" />
        <div className="bg-white/5 rounded-2xl p-8 h-96" />
      </div>

      {/* Other sections... just a few placeholders */}
      <div className="bg-white/5 rounded-2xl p-8 h-48 w-full" />
      <div className="bg-white/5 rounded-2xl p-8 h-48 w-full" />
    </div>
  );
}
    ...
    <div className="px-4 py-8 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-12">
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 mt-4 space-y-1">
          <p>
            * Analysis covers the <strong>entire history</strong> of ProtoPedia.
          </p>
          <p>
