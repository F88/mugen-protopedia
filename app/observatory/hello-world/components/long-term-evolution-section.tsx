...
export function LongTermEvolutionSection({
  ...
  const { longestMaintenance, averageMaintenanceDays } = longTermEvolution;
                ...
                <div className="flex items-center justify-between gap-3 sm:gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="inline-flex shrink-0 items-center justify-center w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 text-[10px] sm:text-xs font-bold">
                        {index + 1}
                      </span>
                      <a
                  ...
                  <div className="flex flex-col items-end gap-0.5 shrink-0">
                    <div className="text-lg sm:text-2xl font-bold text-emerald-600 dark:text-emerald-400 whitespace-nowrap">
