...
describe('Time utilities', () => {
  describe('parseAsProtoPediaTimestamp', () => {
    ...
    it('returns undefined for out-of-range date values', () => {
      // Month 13
      expect(
        parseAsProtoPediaTimestamp('2025-13-01 00:00:00.0'),
      ).toBeUndefined();
      // Month 00
      expect(
        parseAsProtoPediaTimestamp('2025-00-01 00:00:00.0'),
      ).toBeUndefined();
      // Day 32
      expect(
        parseAsProtoPediaTimestamp('2025-12-32 00:00:00.0'),
      ).toBeUndefined();
      // Day 00
      expect(
        parseAsProtoPediaTimestamp('2025-12-00 00:00:00.0'),
      ).toBeUndefined();
    });

    it('returns undefined for out-of-range time values', () => {
      // Hour 24
      expect(
        parseAsProtoPediaTimestamp('2025-12-01 24:00:00.0'),
      ).toBeUndefined();
      // Minute 60
      expect(
        parseAsProtoPediaTimestamp('2025-12-01 23:60:00.0'),
      ).toBeUndefined();
      // Second 60
      expect(
        parseAsProtoPediaTimestamp('2025-12-01 23:59:60.0'),
      ).toBeUndefined();
    });
    ...
    it('handles leap year dates correctly', () => {
      ...
      // Invalid leap year date (non-leap year)
      expect(
        parseAsProtoPediaTimestamp('2025-02-29 12:00:00.0'),
      ).toBeUndefined();
    });
